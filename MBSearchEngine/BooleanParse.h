...
namespace MBSearchEngine
{
	...
	//deprecated, borde inte anv�ndas
	...
	//	{
	//		//space �r en delimiter, men vi vill kunna skriva strings p� vanligt s�tt med "" som phrase och \ som escape character
	...
	//				}
	//			}
	//			//vi vill till skilnad fr�n mellanslag ha med quoten i tokenen
